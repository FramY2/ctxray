# CtxRay live benchmark 2026-08-09-v1
...
- Quality passes: 20/20
- Comparable quality-passing pairs: 10/10
- Estimated model-visible prompt reduction: 73.3%
- Exact aggregate turn-token reduction: 29.1%
- Median paired aggregate-token reduction: 28.2%

| Requested model | Pairs | Baseline tokens | Optimized tokens | Reduction |
| --------------- | ----: | --------------: | ---------------: | --------: |
| gpt-5.6-luna    |     4 |          83,842 |           57,631 |     31.3% |
| gpt-5.6-sol     |     3 |          76,190 |           54,749 |     28.1% |
| gpt-5.6-terra   |     3 |          75,941 |           54,945 |     27.6% |
